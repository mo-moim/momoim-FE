...
export function Select({ size, data, value, defaultValue, placeholder, firstItem, onChange }: SelectProps) {
  const firstItemFilter = firstItem ? data.slice(1) : data;

  return (
    <SelectWrap value={value} defaultValue={placeholder ? defaultValue : data[0].value} onValueChange={onChange}>
