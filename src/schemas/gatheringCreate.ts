...
export const gatheringCreateSchema = z.object({
  name: z.string().min(2, "모임 제목은 2자 이상이어야 합니다").max(25, "모임 제목은 25자 이하여야 합니다."),
  ...
  address: z.string().min(2, "모임할 주소는 2자 이상이어야 합니다."),
  ...
  description: z.string().min(10, "모임 설명은 최소 10자 이상이여야 합니다."),
});
